      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Tabel Postingan Lowongan kerja</h2>
              <p> Tabel ini menampilkan data postingan lowongan kerja yang tersedia di BKK SMK YPC TASIKMALAYA  </p>
                      ...
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr style="background-color: rgb(82, 80, 80)" >
                                ...
                                <th scope="col">lowongan pekerjaan</th>
