      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Tabel perusahaan</h2>
              <p> Tabel ini menampilkan data perusahaan yang bekerjasama dengan BKK SMK YPC TASIKMALAYA  </p>
                  ...
                  <div class="card shadow">
                    <div class="card-body">
                      ...
                      <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($perusahaan as $key => $perusahaan)

                               <tr>
                                  <td>{{ $loop->iteration}}</td>
                                   <td class="text-center">
                                    <p class="fw-bold mb-1"><img src="/storage/{{$perusahaan->image}}" width="150" ></p>
