...
<html lang="en">
  <head>
    ...
    <title>Tabel perusahaan - admin bkk</title>
    <!-- Simple bar CSS -->
      ...
      <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <div class="w-100 mb-4 d-flex">
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="halaman_admin">
              <h4>BKK <span style="color: royalblue">SMK YPC</span></h4>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              <a href="#tables" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">data data </span>
              </a>
              <ul class="collapse list-unstyled pl-4 w-100" id="tables">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="ap"><span class="ml-1 item-text"> data perusahaan</span></a>
                  <a class="nav-link pl-3" href="angan"><span class="ml-1 item-text"> data postingan</span></a>
                  <a class="nav-link pl-3" href="awan"><span class="ml-1 item-text"> data pengajuan</span></a>
                </li>
              </ul>
            </li>
          </ul>
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Tabel Pengajuan</h2>
              <p> Tabel ini menampilkan data orang yang mengajukan atau melamar pekerjaan yang tersedia di BKK SMK YPC TASIKMALAYA  </p>
              ...
              <div class="row">
                ...
                <div class="col-md-12 my-4">
                  <div class="card shadow">
                    <div class="card-body">
                        <a href="{{ route('pengajuan.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                      {{-- <h5 class="card-title">Striped rows</h5> --}}
                      {{-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> --}}
                      <table class="table table-striped table-hover">
                        <thead>
                          <tr style="background-color: rgb(82, 80, 80)" >
                        ...
                        <tbody>
                            @foreach ($pengajuan as $key => $pengajuan)
                               ...
                               <tr>
                                  ...
                                  <td class="text-center">
                                   <p class="fw-bold mb-1"><img src="/storage/{{$pengajuan->image}}" width="150" ></p>
                                         {{-- <img src="{{ asset('/storage/perusahaans/'.$perusahaan->image) }}" class="rounded" style="width: 150px"> --}}
                                  </td>
                                    ...
                                    {{-- <td>
                                     <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                          <a class="dropdown-item"  href="{{ route('perusahaan.show', $perusahaan->id) }}" class="btn btn-sm btn-dark">Detail</a>
                                          <a class="dropdown-item"  href="{{ route('perusahaan.edit', $perusahaan->id) }}" class="btn btn-sm btn-primary">Edit</a>
