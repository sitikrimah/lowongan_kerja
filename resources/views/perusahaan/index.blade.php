...
<head>
    ...
    <title>Data perusahaan - BKK</title>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('perusahaan.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                              ...
                              @forelse ($perusahaan as $perusahaan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="/storage/perusahaans/{{$perusahaan->image}}" width="150" >  {{-- <img src="{{ asset('/storage/perusahaans/'.$perusahaan->image) }}" class="rounded" style="width: 150px"> --}}
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('perusahaan.destroy', $perusahaan->id) }}" method="POST">
                                            <a href="{{ route('perusahaan.show', $perusahaan->id) }}" class="btn btn-sm btn-dark">SHOW</a>
